/*
TinyGPS++ library has been modified to suit on the de10-nano FPGA
*/
...
{
   //bool const isValid()    { return valid; }
   //bool const isUpdated()  { return updated; }
   //uint32_t age() const    { return valid ? (get_cpu_usecs()/MS_TO_US) - lastCommitTime : (uint32_t)ULONG_MAX; }
