...
int main(int argc, char **argv)
{
  ...
  // i2c_write(MPU6050_I2C_ADDRESS, MPU6050_GYRO_CONFIG, 0x08);
  // i2c_write(MPU6050_I2C_ADDRESS, MPU6050_ACCEL_CONFIG, 0x10);
  // i2c_write(MPU6050_I2C_ADDRESS, MPU6050_CONFIG_REG, 0x03);
  // printf("PWR_MGMT_1 = 0x%.2X\n", i2c_read(MPU6050_I2C_ADDRESS, MPU6050_PWR_MGMT_1));
  ...
  // while(1)
  {
    ...
    delay(100);
      ...
      else
      {
        ...
        // if(loop_counter == 0)Serial.printf("Pitch: ");
        // if(loop_counter == 1)Serial.printf(angle_pitch ,0);
        // if(loop_counter == 2)Serial.printf(" Roll: ");
        // if(loop_counter == 3)Serial.printf(angle_roll ,0);
        // if(loop_counter == 4)Serial.printf(" Yaw: ");
